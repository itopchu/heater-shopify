...
export function WhatsAppBubble() {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-[60] flex h-12 w-12 items-center justify-center rounded-full shadow-[0_10px_30px_rgba(0,0,0,0.18),0_2px_6px_rgba(0,0,0,0.12)] transition-transform duration-200 ease-out hover:scale-[1.06] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#25D366] md:bottom-6 md:right-6 md:h-16 md:w-16"
