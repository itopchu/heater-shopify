/**
 * Server component. Renders the AI-readable factual block for AI search
 * crawlers (Google AI Overview, Perplexity, ChatGPT browsing).
 *
 * Spec ref: shop/11_google_search_ai_readiness_checklist.md — short factual
 * paragraph + key-fact list + compatibility note, all in HTML, no client JS.
 *
 * Hidden entirely if `entitySummary` is missing (the upstream Claude generator
 * always writes that field, so absence == not-yet-generated).
 */
