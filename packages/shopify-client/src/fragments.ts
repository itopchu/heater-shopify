...
export const HEATING_PRODUCT_METAFIELD_IDENTIFIERS = [
  ...
  // Long-form sections — per-locale variants. The PDP renders the metafield
  // matching the active locale; EN/DE are the original dual pattern,
  // NL/FR were generated by `generate-section-translations.mjs`.
  { namespace: "content", key: "sections_en" },
  { namespace: "content", key: "sections_de" },
  { namespace: "content", key: "sections_nl" },
  { namespace: "content", key: "sections_fr" },
